...
def BertForwardLayer():
    ...
    # =============== get K, Q, and V ====================== #
    input_tensor_2d = relay.reshape(input_tensor, [-3, v_input_dim]) # shape = (batch_size * seq_len, input_dim)
    ...
    k_tensor = relay.reshape(k_tensor, [v_batch_size, v_seq_len, v_num_heads, v_input_dim // v_num_heads]) # shape = (batch_size, seq_len, num_heads, input_dim // num_heads)
    ...
    q_tensor = relay.reshape(q_tensor, [v_batch_size, v_seq_len, v_num_heads, v_input_dim // v_num_heads]) # shape = (batch_size, seq_len, num_heads, input_dim // num_heads)
    ...
    v_tensor = relay.reshape(v_tensor, [v_batch_size, v_seq_len, v_num_heads, v_input_dim // v_num_heads]) # shape = (batch_size, seq_len, num_heads, input_dim // num_heads)
    v_tensor = relay.transpose(v_tensor, [0, 2, 1, 3]) # shape = (batch_size, num_heads, seq_len, input_dim // num_heads)

    # =============== attention =========================== #
    k_tensor = relay.reshape(k_tensor, [-3, -1, v_input_dim // v_num_heads])
    q_tensor = relay.reshape(q_tensor, [-3, -1, v_input_dim // v_num_heads])
    ...
    attention_scores = relay.reshape(attention_scores, [v_batch_size, v_num_heads, v_seq_len, v_seq_len]) # shape = (batch_size, num_heads, seq_len, seq_len)
    ...
    attention_out = relay.reshape(attention_out, [v_batch_size, v_seq_len, v_input_dim]) # shape = (batch_size, seq_len, input_dim)
