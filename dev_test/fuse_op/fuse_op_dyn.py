...
def BertForwardLayer():
    ...
    input_tensor_2d = dyn_reshape(input_tensor, [-3, v_input_dim]) # shape = (batch_size * seq_len, input_dim)
    ...
    # =============== attention =========================== #
    k_tensor = dyn_reshape(k_tensor, [-3, -1, v_input_dim // v_num_heads])
    q_tensor = dyn_reshape(q_tensor, [-3, -1, v_input_dim // v_num_heads])
